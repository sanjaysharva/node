                ...
                <div className="absolute top-full mt-2 w-56 bg-card rounded-lg shadow-lg border border-card text-sm py-2 z-50 right-0">
                  ...
                  <div className="px-4 py-2">
                    <h4 className="text-gray-400 text-sm font-semibold mb-2">Social</h4>
                      ...
                      <a href="https://discord.gg/sE8E3gYG" target="_blank" rel="noopener noreferrer" className="flex items-center px-4 py-2 text-white hover:bg-gray-700 transition-colors text-sm" data-testid="link-discord">
