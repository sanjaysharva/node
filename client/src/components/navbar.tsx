                ...
                <div className="absolute top-full mt-2 w-56 bg-card rounded-lg shadow-lg border border-card text-sm py-2 z-50 right-0">
                  ...
                  <div className="px-4 py-2">
                    <h4 className="text-gray-400 text-sm font-semibold mb-2">Social</h4>
                      ...
                      <a href="https://discord.gg/nM8WKPAvsW" target="_blank" rel="noopener noreferrer" className="flex items-center px-4 py-2 text-white hover:bg-gray-700 transition-colors text-sm" data-testid="link-discord">
                      ...
                      <a href="https://www.facebook.com/profile.php?id=61580920076690" target="_blank" rel="noopener noreferrer" className="flex items-center px-4 py-2 text-white hover:bg-gray-700 transition-colors text-sm" data-testid="link-facebook">
                        <Facebook className="w-4 h-4 mr-3" />
                        Facebook
                      </a>
                      <a href="https://www.instagram.com/axiom.advertise.co?igsh=bnM4azN2MnFoc2Jn" target="_blank" rel="noopener noreferrer" className="flex items-center px-4 py-2 text-white hover:bg-gray-700 transition-colors text-sm" data-testid="link-instagram">
                        <Instagram className="w-4 h-4 mr-3" />
                        Instagram
                      </a>
                      <a href="https://youtube.com/@axiom-ad?si=GCUzRNKf4JlVHijh" target="_blank" rel="noopener noreferrer" className="flex items-center px-4 py-2 text-white hover:bg-gray-700 transition-colors text-sm" data-testid="link-youtube">
