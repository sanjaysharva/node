      ...
      <div className="block sm:hidden">
        <div className="flex flex-col items-center space-y-6 mb-8">
          <div className="flex items-center space-x-3">
            <img alt="Silly Development Logo" loading="lazy" width="70" height="70" decoding="async" data-nimg="1" className="rounded-full hover:shadow-lg hover:shadow-indigo-500/50 transition-shadow duration-300" style={{color:'transparent'}} src="/assets/axiom_logo.png" />
            
            <span className="text-white font-bold text-2xl" style={{ fontFamily: "'Comic Sans MS', cursive, sans-serif" }}>Axiom Advitisers</span>
            </div>
            <p className="text-gray-400 text-sm text-center max-w-xs">We are a small hosting provider focused on providing the best service we can to our thousands of users.</p>
          </div>
          <div className="grid grid-cols-2 gap-y-8 gap-x-4">
            <div className="space-y-3 text-center">
              <h3 className="text-white font-semibold text-lg relative inline-block after:content-[''] after:block after:w-12 after:h-0.5 after:bg-indigo-600 after:mt-1 mx-auto">Services</h3><ul className="space-y-2">
                <li>
            ...
            <div className="space-y-3 text-center">
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <a
                    className="text-gray-400 hover:text-white transition-all duration-200 text-sm flex items-center justify-center"
                    href="https://status.sillydev.co.uk"
                  >
                    <svg
                      aria-hidden="true"
                      focusable="false"
                      ...
                      className="svg-inline--fa fa-gauge-high text-indigo-400 mr-2 w-3 h-3"
                      role="img"
            ...
            <div className="space-y-3 text-center">
              ...
              <ul className="space-y-2">
                <li>
                  <a
                    className="text-gray-400 hover:text-white transition-all duration-200 text-sm flex items-center justify-center"
                    href="https://client.sillydev.co.uk/privacy"
                  >
                    <svg
                      aria-hidden="true"
                      focusable="false"
                      data-prefix="fas"
                      data-icon="lock"
                      className="svg-inline--fa fa-lock text-indigo-400 mr-2 w-3 h-3"
                      role="img"
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 448 512"
                    >
                ...
                <li>
                  <a
                    className="text-gray-400 hover:text-white transition-all duration-200 text-sm flex items-center justify-center"
                    href="https://client.sillydev.co.uk/tos"
                  >
                    <svg
                      aria-hidden="true"
                      focusable="false"
                      data-prefix="fas"
                      data-icon="gavel"
                      className="svg-inline--fa fa-gavel text-indigo-400 mr-2 w-3 h-3"
                      role="img"
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 512 512"
                    >
                ...
                <li>
                  <a
                    className="text-gray-400 hover:text-white transition-all duration-200 text-sm flex items-center justify-center"
                    href="https://client.sillydev.co.uk/fairuse"
                  >
                    <svg
                      aria-hidden="true"
                      focusable="false"
                      ...
                      className="svg-inline--fa fa-scale-balanced text-indigo-400 mr-2 w-3 h-3"
                      role="img"
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 640 512"
                    >
            ...
            <div className="space-y-3 text-center">
              ...
              <ul className="space-y-2">
                <li>
                  ...
                  >
                    <svg
                      ...
                      data-prefix="fab"
                      data-icon="discord"
                      className="svg-inline--fa fa-discord text-indigo-400 mr-2 w-3 h-3"
                      role="img"
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 640 512"
                    >
                ...
                <li>
                  <a
                    className="text-gray-400 hover:text-white transition-all duration-200 text-sm flex items-center justify-center"
                    href="https://github.com/Silly-Development"
                  >
                    <svg
                      aria-hidden="true"
                      focusable="false"
                      data-prefix="fab"
                      data-icon="github"
                      className="svg-inline--fa fa-github text-indigo-400 mr-2 w-3 h-3"
                      role="img"
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 496 512"
                    >
                ...
                <li>
                  ...
                  >
                    <svg
                      ...
                      data-prefix="fab"
                      data-icon="twitter"
                      className="svg-inline--fa fa-twitter text-indigo-400 mr-2 w-3 h-3"
                      role="img"
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 512 512"
                    >
