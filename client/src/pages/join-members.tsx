...
import { Search, Users, UserPlus, MessageCircle, Crown, Star } from "lucide-react";
import { useAuth } from "@/lib/auth";
...
export default function JoinMembers() {
      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center max-w-md mx-auto">
            ...
            <p className="text-muted-foreground max-w-md mx-auto">
              Please login with Discord to find and connect with community members.
            </p>
          </div>
        </div>
      </div>
  ...
  const members = [
    {
      ...
      serversOwned: 5,
      totalMembers: 12500,
      description: "Building amazing Discord communities since 2020",
      joinedAt: "2020-01-15"
    },
    {
      id: 2,
      ...
      serversOwned: 3,
      totalMembers: 8900,
      description: "Gaming enthusiast and community moderator",
      joinedAt: "2021-05-20"
    },
    {
      id: 3,
      ...
      serversOwned: 7,
      totalMembers: 15600,
      description: "Full-stack developer creating tech communities",
      joinedAt: "2019-11-10"
    },
    {
      id: 4,
      username: "ArtistCollective",
      avatar: null,
      status: "dnd",
      badges: ["verified"],
      serversOwned: 2,
      totalMembers: 5400,
      description: "Passionate about digital art and creative spaces",
      joinedAt: "2022-03-08"
    }
  ];
  ...
  const getBadgeInfo = (badge: string) => {
    switch (badge) {
      case "premium":
        return { icon: Crown, color: "bg-yellow-100 text-yellow-800", text: "Premium" };
      case "verified":
        return { icon: Star, color: "bg-blue-100 text-blue-800", text: "Verified" };
      case "partner":
        return { icon: Users, color: "bg-purple-100 text-purple-800", text: "Partner" };
      case "developer":
        return { icon: MessageCircle, color: "bg-green-100 text-green-800", text: "Developer" };
      default:
        return { icon: Star, color: "bg-gray-100 text-gray-800", text: badge };
    }
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground text-lg mb-6">
            Connect with fellow Discord community builders and enthusiasts
          </p>
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2 mt-2">
                        {member.badges.map((badge, index) => {
                          ...
                          return (
                            <Badge key={index} className={badgeInfo.color}>
              ...
              <CardContent>
                <div className="grid grid-cols-2 gap-4 mb-4">
                  <div className="text-center p-3 bg-muted rounded-lg">
                    <div className="text-2xl font-bold text-primary">{member.serversOwned}</div>
                    <div className="text-sm text-muted-foreground">Servers Owned</div>
                  </div>
                  <div className="text-center p-3 bg-muted rounded-lg">
                    <div className="text-2xl font-bold text-secondary-foreground">{member.totalMembers.toLocaleString()}</div>
        ...
        <div className="mt-8 text-center">
          <Card className="max-w-md mx-auto">
            <CardHeader>
              <CardTitle>Want to be featured?</CardTitle>
              <CardDescription>
                Active community builders get highlighted here
              </CardDescription>
            </CardHeader>
            <CardContent>
