    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="flex justify-between items-start mb-8">
          ...
          <Card className="border-2 border-blue-200 dark:border-blue-800 bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-950/30 dark:to-purple-950/30 w-80">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row gap-8">
              ...
              {loadingServers ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {advertisingServers.map((server: Server) => (
                    <Card key={server.id} className="hover:shadow-lg transition-all duration-300 hover:scale-105 relative overflow-hidden border-2 border-blue-100 dark:border-blue-800 bg-gradient-to-br from-blue-50/50 to-purple-50/50 dark:from-blue-950/20 dark:to-purple-950/20">
          ...
          <div className="lg:w-80 space-y-6">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="bg-blue-50 dark:bg-blue-950/30 border border-blue-300 dark:border-blue-700 rounded-md p-3">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="font-bold text-blue-600">{user?.coins || 0} coins</span>
                  </div>
            ...
            {/* Fair Play Rules Quick Reference - Updated Colors */}
            <Card className="bg-blue-50 dark:bg-blue-950/30 border-2 border-blue-200 dark:border-blue-800 shadow-lg">
              <CardHeader className="pb-3">
                <CardTitle className="text-lg font-bold text-blue-700 dark:text-blue-300 flex items-center">
                  <AlertCircle className="w-5 h-5 mr-2" />
                  ⚖️ Fair Play Rules
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-3">
                <div className="bg-red-100 dark:bg-red-950/30 border border-red-300 dark:border-red-700 rounded-md p-3">
                  <div className="flex items-center space-x-2 mb-1">
                    <AlertCircle className="w-4 h-4 text-red-500" />
                    <span className="text-sm font-semibold text-red-700 dark:text-red-300">Leaving Penalty</span>
                  </div>
                  <p className="text-xs text-red-600 dark:text-red-200">0.75 coin penalty for leaving within 3 days</p>
                </div>

                <div className="bg-green-100 dark:bg-green-950/30 border border-green-300 dark:border-green-700 rounded-md p-3">
                  <div className="flex items-center space-x-2 mb-1">
                    <CheckCircle className="w-4 h-4 text-green-500" />
                    <span className="text-sm font-semibold text-green-700 dark:text-green-300">Quality Only</span>
                  </div>
                  <p className="text-xs text-green-600 dark:text-green-200">Real users only - no bots or fake accounts</p>
                </div>
      ...
      <footer className="bg-card border-t border-border mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="space-y-4">
              <div className="flex items-center space-x-2">
                <i className="fab fa-discord text-2xl text-blue-600"></i>
                <span className="font-bold text-xl bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Smart Serve</span>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-muted-foreground">
                <li><a href="#" className="hover:text-blue-600 transition-colors">Join Members</a></li>
                <li><a href="#" className="hover:text-blue-600 transition-colors">Server Discovery</a></li>
                <li><a href="#" className="hover:text-blue-600 transition-colors">Coin System</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-muted-foreground">
                <li><a href="/help-center" className="hover:text-blue-600 transition-colors">Help Center</a></li>
                <li><a href="/help-center" className="hover:text-blue-600 transition-colors">Contact Us</a></li>
                <li><a href="/terms-of-service" className="hover:text-blue-600 transition-colors">Terms of Service</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-muted-foreground">
                ...
                <li><a href="https://discord.gg/smartserve" className="hover:text-blue-600 transition-colors">Discord Server</a></li>
