...
import { Calendar, Upload, Gift, Users, Clock, MapPin, Award, ExternalLink, ArrowLeft } from "lucide-react";
...
export default function EditEventPage() {
  ...
  const [, params] = useRoute("/edit-event/:id");
  ...
  const updateEventMutation = useMutation({
    mutationFn: async (data: any) => {
      const response = await apiRequest(`/api/events/${params?.id}`, "PUT", data);
