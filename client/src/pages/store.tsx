...
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card";
import { Badge } from "@/components/ui/badge";
import { ShoppingCart, Coins, Star, Zap, Crown } from "lucide-react";
import { useAuth } from "@/lib/auth";

export default function Store() {
  const { isAuthenticated } = useAuth();
  const [coins, setCoins] = useState(100); // Mock user coins
  ...
  const storeItems = [
    {
      id: 1,
      name: "Coin Pack (100)",
      description: "Get 100 coins to spend on premium features",
      price: 100,
      type: "coins",
      icon: Coins,
      color: "bg-yellow-500"
    },
    {
      id: 2,
      name: "Server Boost",
      description: "Boost your server visibility for 30 days",
      price: 50,
      type: "boost",
      icon: Zap,
      color: "bg-blue-500"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground text-lg mb-6">
            Purchase coins, boosts, and premium features to enhance your experience
          </p>
          <div className="flex items-center justify-center space-x-2 bg-card rounded-lg p-4 border">
        ...
        <div className="mt-12 text-center">
          <Card className="max-w-md mx-auto">
            <CardHeader>
              ...
              <CardDescription>
                Purchase coin packs to get access to premium features
              </CardDescription>
            </CardHeader>
            <CardContent>
