...
import { Server, ArrowLeft, Trash2 } from "lucide-react";
...
export default function EditServerPage() {
  const [, params] = useRoute("/servers/edit/:id");
  ...
  useEffect(() => {
    if (server?.tags) {
      const tags = typeof server.tags === 'string' 
        ? server.tags.split(',').map((t: string) => t.trim()).filter(Boolean)
  ...
  const updateMutation = useMutation({
    mutationFn: async (data: Partial<ServerFormData>) => {
      const processedData = {
        ...data,
        tags: selectedTags.join(','),
      };
      return await apiRequest(`/api/servers/${serverId}`, {
        method: "PATCH",
        ...
        <div className="container mx-auto px-4 py-8">
          <Card className="bg-gray-900 border-gray-800">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-gray-400">You need to be logged in to edit servers.</p>
            </CardContent>
          </Card>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          <div className="mb-6">
            ...
            <h1 className="text-3xl font-bold text-white mb-2">Edit Server</h1>
            <p className="text-gray-400">Update your server information</p>
          </div>
              ...
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-gray-200">Server Name</FormLabel>
                        <FormControl>
                  ...
                  <div className="space-y-3">
                    <FormLabel className="text-gray-200">Tags (Select up to 10)</FormLabel>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-gray-200">Invite Code</FormLabel>
                        <FormControl>
                          <Input {...field} className="bg-gray-800 border-gray-700 text-white" />
                        </FormControl>
                        <FormMessage />
